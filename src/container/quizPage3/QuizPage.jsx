  ...
  return (
    <div className='quizpage-container'>
      ...
      <div className='quizpage-inner'>
        <h2>
          The following are the key features that make blockchain unique except
          ____
        </h2>
        ...
        <ul className='options'>
          <li className='correct'>
            {' '}
            <img src={images.q3a} alt='' onClick={() => setIsModalOpen(true)} />
          </li>

          <li className='not-correct' onClick={checkAnswer}>
            <img src={images.q3b} alt='' onClick={() => setIsModalOpen(true)} />
          </li>

          <li className='not-correct' onClick={checkAnswer}>
            <img src={images.q3c} alt='' onClick={() => setIsModalOpen(true)} />
          </li>

          <li className='not-correct' onClick={checkAnswer}>
            <img src={images.q3d} alt='' onClick={() => setIsModalOpen(true)} />
          </li>
        </ul>
      </div>
      ...
      {answerWrong ? (
        <div className='modal'>
          ...
          <div className='modal-content'>
            ...
            <img src={images.fail} alt='' onClick={() => navigate('/quiz4')} />
          </div>
        </div>
      ) : null}
